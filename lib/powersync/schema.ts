...
const farms = new Table(
  {
    ...
    weaning_days: column.integer,
    famacha_recheck_days: column.integer,
...
const breedingEvents = new Table(
  {
    ...
    exposure_end_date: column.text,
    due_date: column.text,
    due_window_start: column.text,
    due_window_end: column.text,
    status: column.text,
    confirmed_date: column.text,
    confirm_method: column.text,
...
const healthRecords = new Table(
  {
    ...
    meat_withdrawal_days: column.integer,
    milk_withdrawal_days: column.integer,
    route: column.text,
